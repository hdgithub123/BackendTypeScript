...
export default async function insertObjectsTreeTablesUniqueFieldNotIsSystem(
  tablesData: Array<{
    table: string;
      ...
      for (const dataInsertRaw of dataIn) {
        ...
        if (parentId) {
          ...
          if (!isLeaf) {
            ...
            if (hasIsSystem) newRowFiltered.isSystem = false;
          ...
          if (hasIsSystem) newRow.isSystem = false;
